    ...
    <div className="space-y-6">
         <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Search, view, and manage system organizations.</p>
            </div>
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
                 <div className="relative flex-1 md:w-64">
                    ...
                    <input
                        ...
                        className="w-full pl-9 pr-4 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-colors text-gray-900 dark:text-white"
                    />
                 </div>
                <button
                    ...
                    className="flex-none flex items-center gap-2 px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg font-medium transition-colors"
                >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <table className="w-full">
                <thead className="bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                    <tr>
                        <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Organization</th>
                        ...
                        <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Mode</th>
                    ...
                    {filteredOrgs.map(org => {
                        ...
                        return (
                            <tr
                                ...
                                className={`group hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer ${isOutOfService ? 'bg-gray-50/50 dark:bg-gray-800/50' : ''}`}
                            >
                                <td className="px-6 py-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="min-w-0 max-w-xs">
                                            <div className={`font-medium truncate ${isOutOfService ? 'text-gray-500 line-through' : 'text-gray-900 dark:text-white'}`}>{org.name}</div>
                                            <div className="text-xs text-gray-400 truncate">{org.description || 'No description provided'}</div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td className="px-6 py-4">
                                    <span className="text-xs font-mono text-gray-600 dark:text-gray-300 uppercase bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">
                                        {org.submitMode || 'API'}
                                    </span>
                                </td>
            ...
            <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                <div className="bg-white dark:bg-slate-900 w-full max-w-2xl rounded-2xl shadow-2xl flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500 outline-none transition-all text-slate-800 dark:text-white"
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-sm outline-none transition-all ${isEditingExisting ? 'text-slate-500 cursor-not-allowed bg-slate-100' : 'text-slate-800 dark:text-white focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500'}`}
                                    />
                                </div>
                                <div className="md:col-span-2">
                                     ...
                                     <textarea
                                        ...
                                        className="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm h-24 resize-none focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500 outline-none transition-all text-slate-800 dark:text-white"
                                    ...
                                    {editingOrg.features?.ai && (
                                        <div className="mt-4 pl-8 space-y-4">
                                            <div>
                                                ...
                                                {availableAiApis.length > 0 ? (
                                                    <select
                                                        ...
                                                        className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500 outline-none transition-all text-slate-800 dark:text-white"
                                                    >
                                                    ...
                                                    <div className="text-xs text-red-500 bg-red-50 dark:bg-red-900/20 p-2 rounded-lg border border-red-200 dark:border-red-800">
                                            ...
                                            <div>
                                                ...
                                                <textarea
                                                    className="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-sm h-32 resize-none focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500 outline-none transition-all text-slate-800 dark:text-white"
                    ...
                    <div className="p-6 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3 bg-gray-50 dark:bg-gray-900/50">
                        <button onClick={() => setEditingOrg(null)} className="px-4 py-2 rounded-lg font-medium text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">Cancel</button>
                        <button onClick={handleSave} className="px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg font-medium transition-colors">Save Organization</button>
                    </div>
                </div>
            </div>
        )}

...
import { Send, X, Sparkles, User as UserIcon, Bot, CheckCircle, AlertTriangle, Loader2 } from 'lucide-react';
...
export const AiAssistant: React.FC<AiAssistantProps> = ({ mode, onClose, org, assets, onApplyUpdates, onApplyFilter, systemConfig, apis = [] }) => {
  ...
  const speakResponse = (text: string) => {
      ...
      let cleanText = text.replace(/\b(\d{4})-(\d{2})-(\d{2})\b/g, (_match, y, m, d) => {

...
import { PfaView, ViewMode, SeriesVisibility, Scale, DisplayMetric, GridColumn, GroupingField, ColorConfig, SortConfig, ColumnId, AssetMasterRecord, ClassificationRecord } from '../types';

interface TimelineLabProps {
    pfaRecords: PfaView[]; // Filtered PFA records passed from parent
...
export const TimelineLab: React.FC<TimelineLabProps> = ({ 
  ...
  const [grouping, _setGrouping] = useState<GroupingField[]>(['category']); 

...
import { 
  ...
  Tag, MapPin, CheckSquare, 
  CalendarRange, Activity, PanelLeftClose, ChevronDown,
  ZoomIn, Plus, Minus, Crosshair, Lock
} from 'lucide-react';
...
export const FilterPanel: React.FC<FilterPanelProps> = ({
  ...
  const toggleFilter = (key: keyof FilterState, value: string, allowEmpty = true) => {
        ...
        >
            <div className="flex items-center gap-2.5">
                ...
                <div>
                    ...
                    <p className="text-[9px] text-slate-400 font-bold tracking-wide">Control Center</p>
                </div>
            </div>
            {onClose && (

...
import { PfaRecord, TimelineBounds, DragState, GroupingField, SeriesVisibility, Scale, DisplayMetric, GridColumn, GroupNode, ColorConfig, SortConfig, ColumnId, AssetMasterRecord } from '../types';
import { getDaysDiff, getTimelineTicks, getPixelsPerDay, calculateCost, formatCurrencyCompact, groupAssets, formatCurrency, formatDate, calculateEndDateFromCost, formatTick, addDays, addMonths } from '../utils';
import { CheckSquare, Square, ChevronDown, ChevronRight, Edit2, Lock, PanelLeftClose, PanelLeftOpen, AlertCircle, MinusSquare, ShieldCheck, ArrowUp, ArrowDown, Loader2 } from 'lucide-react';
        ...
        return (
            ...
            >
                ...
                <div className="relative flex-1 h-full">
                     ...
                     {activeLayer && (
                         <div 
                            className={`absolute top-3 h-6 rounded-full shadow-sm flex items-center px-2 transition-all border border-white/20 ${isBeingDragged ? 'z-20 ring-4 ring-opacity-50 shadow-lg scale-[1.02] ring-blue-400' : 'cursor-grab hover:shadow-md hover:scale-[1.01]'} ${isPrimaryDrag ? 'cursor-grabbing' : isBeingDragged ? 'cursor-default' : ''}`}

...
import { aggregateCosts, formatCurrencyCompact, formatCurrency } from '../utils';
import { TrendingUp, TrendingDown, Minus, CircleDollarSign, Maximize2, Minimize2, ArrowRight } from 'lucide-react';
